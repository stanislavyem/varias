		...
		<section className='section_terms section_text'>
			<div className="section__content">
				<div className="container_page container_content">
					...
					<p>These terms and conditions outline the rules and regulations for the use of Datemarks Website.</p>
					<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Datemarks website if you do not accept all of the terms and conditions stated on this page.</p>
					...
					<h2>Cookies</h2>
					<p>We employ the use of cookies. By using Datemarks website you consent to the use of cookies in accordance with Datemarks privacy policy.</p>
					...
					<h2>License</h2>
					<p>Unless otherwise stated, Datemarks and/or it’s licensors own the intellectual property rights for all material on Datemarks All intellectual property rights are reserved. You may view and/or print pages from Datemarks for your own personal use subject to restrictions set in these terms and conditions.</p>
					
					<h2>User Comments</h2>
					<ol>
						<li>This Agreement shall begin on the date hereof.</li>
						<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data (‘Comments’) in areas of the website. Datemarks does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of Datemarks its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Datemarks SERVICE shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
						<li>Datemarks reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
						...
						<li>You hereby grant to Datemarks a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
					</ol>
					...
					<ol>
						...
						<li>We may consider and approve in our sole discretion other link requests from the following types of organizations:
							<ol className='ol_letters'>
								...
								<li>Hosting companies affiliations hyper links</li>
								<li>Travel deals content and travel search engines.</li>
							</ol>
						</li>
					</ol>
					...
					<p>If you have any queries regarding any of our terms, please <a href="mailto:info@datemarks.com" className="underline">contact us</a> via email.</p>
				</div>
			</div>
		</section>
	)
